...
import net.noresttherein.palimpsest.RuntimeType.Specialized.{Fun2, Primitives}
import net.noresttherein.palimpsest.iterables.{AptIterable, IterableTemplate}
...
package object palimpsest {
	...
	/** A specialized version of `scala.Option`.
	  ...
	  * @see [[Sure]]
	  * @see [[Blank]]
	  * @see [[palimpsest.null_?]]
	  * @see [[palimpsest.some_?]]
	  */
...
//todo: adapters/converters from scala classes
	...
	private[palimpsest] def concat[E, R](first :Vals[E], second :TraversableOnce[E])(builder :Builder[E, R]) :R = {
	...
	private[palimpsest] def concat[E, R](first :TraversableOnce[E], second :Vals[E])(builder :Builder[E, R]) :R = {
	...
	private[palimpsest] def span[@specialized(ItemTypes) E, R]
	...
	private[palimpsest] def filter[@specialized(ItemTypes) E, R](src :AptIterator[E], builder :AptBuilder[E, R])
	...
	private[palimpsest] def partition[@specialized(ItemTypes) E, R]
...
/*
	@inline private[palimpsest] final def emptyArray[E](elementType :Class[E]) :Array[E] = {
...
*/
	...
	@inline private[palimpsest] final def newArray[E](elements :Class[_], length :Int) :Array[E] =
	...
	private[palimpsest] final def arrayCopy[E](src :Array[E], srcOffset :Int, dst :Array[E], dstOffset :Int, length :Int) :Unit =
	...
	private[palimpsest] final def slowcopy[E](src :Array[E], srcOffset :Int, dst :Array[E], dstOffset :Int, length :Int) :Unit = {
	...
	@inline private[palimpsest] final def arrayCopy[E](array :Array[E]) :Array[E] = {
		val res = newArray[E](array.getClass.getComponentType, array.length)
		System.arraycopy(array, 0, res, 0, array.length)
		res
	}

	@inline private[palimpsest] final def arrayCopy[E](array :Array[E], from :Int, length :Int) :Array[E] = {
		val res = newArray[E](array.getClass.getComponentType, length)
		System.arraycopy(array, from, res, 0, length)
		res
	}

	@inline private[palimpsest] final def arraySlice[E](from :Int, array :Array[E], until :Int) :Array[E] = {
	...
	private[palimpsest] final def arrayFill[E](array :Array[E], value :E, from :Int=0, until :Int=Int.MaxValue) :Array[E] = {
