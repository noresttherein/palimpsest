...
package object tries {
	...
	/** A type alias for the most basic configuration of [[net.noresttherein.palimpsest.tries.GenericBinaryTrie]],
	...
	/** A type alias for the simplest version of [[net.noresttherein.palimpsest.tries.TrieBranchTemplate]], with
