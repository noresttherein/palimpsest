...
import net.noresttherein.palimpsest.{?, ItemTypes, Var}
import net.noresttherein.palimpsest.RuntimeType.Specialized.{Fun1, Fun2}
import net.noresttherein.palimpsest.iterators.AptIterator
import net.noresttherein.palimpsest.tries.TrieElements.{ElementOf, EmptyElements, LeafElement}
import net.noresttherein.palimpsest.tries.GenericBinaryTrie._
import net.noresttherein.palimpsest.tries.Trie.{FoldPath, KeyTypes, MutableTrieOwner}
import net.noresttherein.palimpsest.iterators.BaseIterator
...
/** A common interface for tries consisting of three node types: empty, leaf and inner branch.
  ...
  * [[net.noresttherein.palimpsest.tries.BinaryTrie.GenericEmptyBinaryTrie]],
  * [[net.noresttherein.palimpsest.tries.BinaryTrie.GenericBinaryTrieLeaf]],
  * [[net.noresttherein.palimpsest.tries.BinaryTrie.GenericBinaryTrieBranch]].
...
//	def patchKey[U >: T <: Trie[K, U]](patch :BinaryTriePatch[K, S, U])(key :K) :U //= foldPath(patch)(key)
	...
	/** An immutable version of this trie. Nodes already effectively immutable will return themselves (which is the default
	  ...
	  * @see [[net.noresttherein.palimpsest.tries.GenericBinaryTrie#view]]
	  * @see [[net.noresttherein.palimpsest.tries.GenericBinaryTrie#copy]]
	  * @see [[net.noresttherein.palimpsest.tries.GenericBinaryTrie#freeze()]]
	  */
	def stable :S
	...
	/** Create a shallow copy of this trie node to mark it as immutable. No modification to the returned trie will be
	  ...
	  * For a truly immutable version with the same contents see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#stable]].
	  *
	  ...
	  * @see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#stable]]
	  * @see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#copy]]
	  * @see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#freeze()]]
	  */
	def view :S
	...
	/** Create a shallow copy of this trie by sharing the contents. No future modifications to either of the references
	  ...
	  * [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#stable]] is that the latter will always
	  ...
	  * @see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#view]]
	  * @see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#stable]]
	  * @see [[net.noresttherein.palimpsest.tries.BinaryTrie.BinaryTrieBranch#freeze()]]
	  */
	def copy :T
...
//	override def asBranch :Nullable[MutableBinaryTrieBranch[K, S, T] with T] = Nullable.Empty
	...
	/** A mutable modification of this trie concerning a single leaf. The implementation depends on whether this trie -
	  ...
	  * [[net.noresttherein.palimpsest.tries.BinaryTrie.MutableBinaryTrieBranch]] from its [[BinaryTriePatch#patchBranch]]
...
//		@inline final override def asBranch :Nullable[MutableBinaryTrieBranch[K, S, T] with T] = Nullable(this)
	...
	/** A trait inherited by several classes building binary tries which need to create a modification of a branch
	  ...
	  * @see [[net.noresttherein.palimpsest.tries.GenericBinaryTrie.BinaryTriePatch]]
	  */
