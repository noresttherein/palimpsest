...
import net.noresttherein.palimpsest.{?, Vals, Var}
import net.noresttherein.palimpsest.RuntimeType.Specialized.Fun2
import net.noresttherein.palimpsest.iterables.{AptIterable, IterableSpecialization, IterableTemplate}
...
import net.noresttherein.palimpsest.seqs.ValList
import net.noresttherein.palimpsest.sets.{SetSpecialization, ValSet}
import net.noresttherein.palimpsest.tries.BinaryTrieKeySetFactory.SharingTrieOp
import net.noresttherein.palimpsest.tries.GenericBinaryTrie.BinaryTriePatch
import net.noresttherein.palimpsest.tries.Trie.MutableTrieOwner
...
//	protected[palimpsest] def contents :T = trie
}
...
//	@inline override final protected[palimpsest] def contents :T = root
