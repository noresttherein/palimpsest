...
import net.noresttherein.palimpsest.{Blank, Var}
import net.noresttherein.palimpsest.{?, Blank, ItemTypes, Var}
import net.noresttherein.palimpsest.iterables.{EmptyIterableFoundation, EmptyIterableTemplate}
import net.noresttherein.palimpsest.tries.Trie.TrieOpRes
