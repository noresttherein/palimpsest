...
import net.noresttherein.palimpsest.SyncVar.TestAndSet
import net.noresttherein.palimpsest.Var.SpecializedTypes
...
object SyncVar {
	...
	/** An intermediate value of a ''test-and-set'' operation initiated by [[net.noresttherein.palimpsest.SyncVar#:?]]. */
