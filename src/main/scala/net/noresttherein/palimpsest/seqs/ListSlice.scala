...
import net.noresttherein.palimpsest.SerializationVersion
import net.noresttherein.palimpsest.iterables.AptCompanion.CanFitFrom
import net.noresttherein.palimpsest.seqs.AptSeq.SeqFoundation
import net.noresttherein.palimpsest._
import net.noresttherein.palimpsest.seqs.LinkedList.{Empty, NonEmpty}
...
import net.noresttherein.palimpsest.iterables.AptIterable.{ElementDeserializer, ElementSerializer}
import net.noresttherein.palimpsest.iterators.CountdownIterator
import net.noresttherein.palimpsest.Vals.OfKnownSize
import net.noresttherein.palimpsest.iterables.{CloneableIterable, IterableSpecialization, SpecializableIterable, SpecializableIterableFactory, StableIterableTemplate}
import net.noresttherein.palimpsest.iterators.AptIterator
import net.noresttherein.palimpsest.seqs.ListSlice.{ListSliceBuilder, ListSliceIterator, SerializedListSlice}
...
//		new ListSliceBuilder(new NonEmpty(Specialized[E].Null))
		...
		extends AptBuilder[E, ListSlice[E]]
	{
		...
		override private[palimpsest] def addOne = { e :E =>
