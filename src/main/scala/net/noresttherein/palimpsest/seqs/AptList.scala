...
import net.noresttherein.palimpsest.iterables.{CloneableIterable, AptCompanion, IterableSpecialization, SpecializableIterable, SpecializableIterableFactory, StableIterableTemplate}
import net.noresttherein.palimpsest.iterators.{CountdownIterator, AptIterator}
import net.noresttherein.palimpsest.seqs.AptList.{AptListBuilder, AptListIterator, FullLink, Link, Terminus}
...
//		new AptListBuilder[E]
	...
	private[seqs] class ReverseAptListBuilder[@specialized(ItemTypes) E] extends AptBuilder[E, AptList[E]] {
		...
		override private[palimpsest] def addOne :E=>Unit =
