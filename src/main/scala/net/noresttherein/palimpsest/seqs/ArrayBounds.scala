...
import net.noresttherein.palimpsest.{arrayCopy, arrayString}
...
/** A simple wrapper over an array and a validated index range, used as a common parameter for many factory methods
  ...
  */
private[palimpsest] class ArrayBounds[E] private[palimpsest](val array :Array[E], val start :Int, val length :Int)
...
private[palimpsest] object ArrayBounds {
