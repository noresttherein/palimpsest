...
import net.noresttherein.palimpsest.iterables.{CloneableIterable, AptCompanion, IterableFoundation, SpecializableIterable, StableIterableTemplate}
import net.noresttherein.palimpsest.{concat, newArray, ofKnownSize, slowcopy, ItemTypes, AptBuilder, RuntimeType}
