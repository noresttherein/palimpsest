...
import net.noresttherein.palimpsest.sets.ByteSet.{ByteSetBitmap, ByteSetBuilder, ByteSetIterator}
...
/** Base class for mutable and immutable sets of `Byte` elements implemented as a bitmap.
  ...
  *
  * @see [[net.noresttherein.palimpsest.sets.ByteSet.MutableByteSet]]
