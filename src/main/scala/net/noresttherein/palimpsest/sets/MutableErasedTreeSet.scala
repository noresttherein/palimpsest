...
import net.noresttherein.palimpsest.maps.RedBlackTree
import net.noresttherein.palimpsest.maps.RedBlackTree.{EntryLens, Node}
import net.noresttherein.palimpsest.maps.RedBlackTree.Node.AnySetNode
import net.noresttherein.palimpsest.ordered.ValOrdering
import net.noresttherein.palimpsest.Vals.OfKnownSize


/** A generic variant of Red-Black tree implementation. We can't use the default optimizations introduced
  * by [[net.noresttherein.palimpsest.maps.RedBlackTree RedBlackTree]] as stored keys are pointers
