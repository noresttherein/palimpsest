...
import net.noresttherein.palimpsest.iterables.{DoubletonFoundation, DoubletonSpecialization, EmptyIterableFoundation, EmptyIterableTemplate, SingletonFoundation, SingletonSpecialization}
import net.noresttherein.palimpsest.{?, Blank, AptBuilder, Vals, RuntimeType, Sure}
import net.noresttherein.palimpsest.iterators.{BaseIterator, FastSizeIterator}
import net.noresttherein.palimpsest.Vals.OfKnownSize
import net.noresttherein.palimpsest.sets.BooleanSet.{BooleanSetIterator, IsTrue}
...
import net.noresttherein.palimpsest.ordered.OrderedBy.OrderedEmpty
