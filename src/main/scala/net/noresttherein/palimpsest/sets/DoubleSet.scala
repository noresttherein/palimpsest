...
import net.noresttherein.palimpsest.tries.{LongTrie, MutableLongTrie, TrieKeySetOps}
import net.noresttherein.palimpsest.tries.TrieElements.{ElementCounter, ElementOf}
import net.noresttherein.palimpsest.Blank
import net.noresttherein.palimpsest.tries.{LongTrie, LongTrieKeys, MutableLongTrie, TrieKeySetOps, TriePotIterableFoundation}
import net.noresttherein.palimpsest.tries.LongTrie.{EmptyLongTrie, LongTrieLeaf}
import net.noresttherein.palimpsest.tries.TrieElements.{ElementCounter, ElementOf}
import net.noresttherein.palimpsest.{?, Blank, RuntimeType, Sure, Vals, Var}
import net.noresttherein.palimpsest.sets.StableDoubleSet.{doubleToKey, DoubleElementCounter}
...
import net.noresttherein.palimpsest.tries.MutableLongTrie.{EmptyMutableLongTrie, MutableLongTrieBranch, MutableLongTrieLeaf}

import scala.collection.GenTraversableOnce


/** Common implementation trait for mutable and immutable sets of long values backed by a [[net.noresttherein.palimpsest.tries.LongTrie]].
