package net.noresttherein.palimpsest.multisets

import java.util

import net.noresttherein.palimpsest
import net.noresttherein.palimpsest.iterables.AptCompanion.CanFitFrom
import net.noresttherein.palimpsest.iterables._
import net.noresttherein.palimpsest.{ItemTypes, AptBuilder, Vals, RuntimeType}
import net.noresttherein.palimpsest.RuntimeType.Specialized.{Fun2, Fun2Res}
import net.noresttherein.palimpsest.iterators.AptIterator
import net.noresttherein.palimpsest.seqs.{ArrayView, AptSeq, SharedArray, SharedArrayBuffer}
import net.noresttherein.palimpsest.sets.{MutableSet, MutableSetSpecialization, SetSpecialization, SpecializableSet, StableSet, ValSet}
...
//			else new MultiSet1(item, until-from)
		...
		protected override def trustedCopyTo(xs: Array[E], start: Int, total: Int) :Int = {
			...
			palimpsest.arrayFill(xs, item, start, count)
			count
		}
