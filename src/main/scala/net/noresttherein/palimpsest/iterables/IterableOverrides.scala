...
import net.noresttherein.palimpsest.{?, Blank, AptBuilder, ItemTypes, Sure}
 ...
 * [[net.noresttherein.palimpsest.iterables.IterableTemplate IterableTemplate]] to their default implementations,
...
/** An implementation trait for `AptIterable` which redefines methods defined in
 * [[net.noresttherein.palimpsest.iterables.IterableSpecialization IterableSpecialization]]
