...
import net.noresttherein.palimpsest.{ItemTypes, AptBuilder, RuntimeType}
	...
	extends GenericTraversableTemplate[E, S]
{
	...
	/** By default delegates, as per the implementation in `GenericTraversableTemplate`, to `companion.newBuilder`.
	  ...
	  * This could be potentially resolved by [[net.noresttherein.palimpsest.AptBuilder.RetardedAptBuilder]]
	...
	/** An equivalent of [[net.noresttherein.palimpsest.iterables.SpecializableIterable#genericBuilder]] which
