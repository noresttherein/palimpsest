...
import net.noresttherein.palimpsest.maps.AptMap.{FilteredKeysView, FilteredMapKeys, KeySetView, MapKeySet, MappedMapValues, MappedValuesView, MapValues}

import scala.collection.{GenTraversableOnce, MapLike}
import net.noresttherein.palimpsest.sets.ValSet
import net.noresttherein.palimpsest.iterators.AptIterator.MappedIterator
...
import net.noresttherein.palimpsest.SpecializePair.{Curry, SpecializeSomePairs}
