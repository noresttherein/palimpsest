...
import net.noresttherein.palimpsest.{?, maps, Blank, ItemTypes, Sure, Var}
import net.noresttherein.palimpsest.iterators.AptIterator
import net.noresttherein.palimpsest.maps.RedBlackTree.{Black, Color, EntryLens, Negative, Node, Positive, Red, RedBlackIterator, ReverseRedBlackIterator}
...
/** A mutable Red-Black Tree implementation trait extended by collection classes optimized for value type keys
  ...
  * [[net.noresttherein.palimpsest.maps.RedBlackTree.Node Node]] base class and thus serve as the tree root
