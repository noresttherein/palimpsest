...
import net.turambar.palimpsest.specialty.iterables.{CloneableIterable, AptCompanion, AptIterable, AptIterableFactory, InterfaceIterableFactory, IterableAdapter, SpecializableIterable}
